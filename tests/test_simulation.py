...
class TestSnapshotAge37:
    ...
    def test_strategic_rental(self):
        ...
        assert r["after_tax_net_assets"] == pytest.approx(75332.137745, abs=0.01)
    ...
    def test_normal_rental(self):
        ...
        assert r["after_tax_net_assets"] == pytest.approx(62235.030973, abs=0.01)
...
class TestSnapshotDetails:
    ...
    def test_nisa_balance(self):
        assert self.r["nisa_balance"] == pytest.approx(33842.945083, abs=0.01)
...
class TestEdgeAges:
    ...
    def test_age_25(self):
        ...
        assert r["after_tax_net_assets"] == pytest.approx(294951.043623, abs=0.01)
    ...
    def test_age_45(self):
        ...
        assert r["bankrupt_age"] is None
        assert r["after_tax_net_assets"] == pytest.approx(27819.164593, abs=0.01)
...
class TestDisciplineFactor:
    def test_lower_factor_reduces_assets(self):
        ...
        assert r_reduced["after_tax_net_assets"] == pytest.approx(61314.498252, abs=0.01)
...
class TestChildBirthAges:
    def test_birth_age_38_matches_snapshot(self):
        ...
        assert r["after_tax_net_assets"] == pytest.approx(74790.166144, abs=0.01)
...
class TestParentalLeave:
    ...
    def test_zero_months_disables(self):
        ...
        assert r["after_tax_net_assets"] == pytest.approx(75984.928723, abs=0.01)
