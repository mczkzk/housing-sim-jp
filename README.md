...
80歳入居→110歳（30年、長寿リスクバッファ）前提の入居審査モデル。施設側が現金カバレッジで審査する想定（投資リターン0%）。

| グレード | 入居時資産（2026年実質） | 月額目安 |
|---------|----------------------|---------|
| S（超高級） | ≥4.71億 | 入居金1億+月50万 |
| A（高級） | ≥3.26億 | 入居金5,000万+月40万 |
| B（準高級） | ≥2.30億 | 入居金2,000万+月30万 |
| C（標準） | ≥1.05億 | 入居金500万+月20万 |
