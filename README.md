...
**20〜40代・世帯年収700〜2,000万の共働きカップル**向けに、マンション購入・一戸建て購入・賃貸のどれが最も資産形成に有利かを、80歳までの月次シミュレーションで比較するツール。確定論（固定リターン）とMonte Carlo（確率分布+生活イベントリスク）の2モードを持つ。

## エリアプリセット

物件価格・家賃・管理費等を**5エリアのプリセット**として用意（2026年実勢価格ベース）。TOML設定の `area = "浦和"` で切り替え可能。
